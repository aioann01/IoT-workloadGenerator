package cy.cs.ucy.ade.aioann01.WorkloadGenerator.HttpServer.HttpServer.Configs;
...
public class ExchangeInterceptor extends HandlerInterceptorAdapter {

    private static final Logger logger = LoggerFactory
            .getLogger(ExchangeInterceptor.class);
